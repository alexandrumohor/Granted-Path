...
export default function Home() {
  ...
  return (
    <div className="h-[calc(100vh-3.5rem)] overflow-hidden flex items-start">
      <div className="w-full px-5 sm:px-8 lg:px-16 xl:px-24 pt-8">
        <div className="grid lg:grid-cols-[1fr_1px_1fr] items-start gap-0">

          {/* ── LEFT ── */}
          <div className="flex flex-col pr-0 lg:pr-12">
            <div className="anim-right delay-1 inline-flex items-center gap-2 rounded-full border border-border bg-card px-4 py-1.5 text-[14px] text-muted-foreground mb-8 w-fit">
            ...
            <div className="anim-right delay-4 mt-8 flex items-center gap-5">
              <Link href="/register">
            ...
            {stats && (
              <div className="anim-right delay-5 mt-8 flex items-center gap-5 text-[14px] text-muted-foreground">
            ...
            {/* AI Preview */}
            <div className="anim-up delay-6 mt-8 rounded-xl border border-border bg-card overflow-hidden" style={{boxShadow:"var(--shadow-card)"}}>
          ...
          {/* ── RIGHT ── */}
          <div className="flex flex-col pl-0 lg:pl-12 mt-10 lg:mt-0 bg-secondary/50 dark:bg-transparent rounded-2xl p-6 lg:p-8 -m-2 lg:m-0">
